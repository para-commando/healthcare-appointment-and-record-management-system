...
public static class QueryExtensions
{
    public static IQueryable<T> ApplyFilters<T>(this IQueryable<T> query, object filter)
    {
        ...
        var propertyOperations = new Dictionary<
            string,
            Func<IQueryable<T>, string, object, IQueryable<T>>
        >
        {
            // Equality checks
            {
                "PatientId",
                (q, prop, val) => q.Where(e => EF.Property<string>(e, prop).Equals(val))
            },
            {
                "DoctorId",
                (q, prop, val) => q.Where(e => EF.Property<string>(e, prop).Equals(val))
            ...
            {
                "AppointmentDate",
                (q, prop, val) => q.Where(e => EF.Property<DateOnly>(e, prop).Equals(val))
            },
            {
                "AppointmentBookedOn",
                (q, prop, val) =>
                    q.Where(e => EF.Property<string>(e, prop).Contains(val.ToString().Trim()))
            },
            {
                "AppointmentStatus",
                (q, prop, val) =>
            ...
            // Less-than checks
            {
                ...
                (q, prop, val) =>
                    q.Where(e => EF.Property<DateOnly>(e, "AppointmentDate") <= (DateOnly)val)
            },
            {
                "AppointmentBookedOnLessThan",
                (q, prop, val) =>
                    q.Where(e => EF.Property<DateTime>(e, "AppointmentBookedOn") <= (DateTime)val)
            },
            // Greater-than checks
            {
            ...
            {
                "AppointmentBookedOnGreaterThan",
                (q, prop, val) =>
                    q.Where(e => EF.Property<DateTime>(e, "AppointmentBookedOn") >= (DateTime)val)
            },
            // Range checks
            {
                "AppointmentBookedOnRange",
                (q, prop, val) =>
                {
                    var range = (AppointmentBookedOnRegRange)val;
                    return q.Where(e =>
                        EF.Property<DateTime>(e, "AppointmentBookedOn") >= range.StartDate
            ...
            },
            {
                ...
                (q, prop, val) =>
                {
                    ...
                    return q.Where(e =>
                        EF.Property<DateOnly>(e, "AppointmentDate") >= range.StartDate
